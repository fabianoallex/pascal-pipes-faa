...
type
  ...
  published
    ...
    procedure PublishBatch_RetainAoVivo_NaoMarcaARetainedParaQuemJaAssinava;
    procedure PublishBatch_TopicoInvalido_NaoPublicaNadaDoLote;
    procedure PublishBatch_DoCliente_SemRelayVaiSoParaOnPublish;
    procedure OnDelivered_FanOut_UmaVezPorAssinante;
    procedure OnDelivered_Retido_ChegaComARetainedTrue;
    procedure OnDelivered_PublishBatch_UmPorItemPorConexao;
    procedure OnDeliveryFailed_PayloadExcedeMaxMessageSize;
  end;
...
begin
  ...
  AssertTrue('OnDelivered nao disparou para o assinante',
...
begin
  ...
  AssertTrue('retido nao chegou ao novo assinante',
    WaitCount(FTopicCount[0], 1, 3000));
  AssertTrue('OnDelivered nao disparou para o replay do retido',
    WaitCount(FDeliveredCount, 1, 3000));
  AssertEquals(1, CountLogIn(FDeliveredLog,
...
begin
  ...
  AssertTrue('OnDelivered nao disparou para os dois itens do lote',
...
begin
  ...
  AssertTrue('OnDeliveryFailed nao disparou para o payload grande demais',
    WaitCount(FDeliveryFailedCount, 1, 3000));
