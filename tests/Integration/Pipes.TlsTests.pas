...
type
  ...
  published
    ...
    [Test] procedure Identidades_DespejamAsMaisAntigasAlemDoTeto;
    [Test] procedure ClientIds_NaoListaConexaoEmHandshake;
    [Test] procedure SendBytes_ParaConexaoEmHandshake_Recusado;
    [Test] procedure Broadcast_ComConexaoEmHandshake_EntregaAosEstabelecidos;
    [Test] procedure MaxClients_ConexaoEmHandshakeOcupaVaga;
