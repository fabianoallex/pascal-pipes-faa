...
uses
  ...
  Pipes.Compression in '..\..\src\Pipes.Compression.pas',
  Pipes.Topics in '..\..\src\Pipes.Topics.pas',
  Pipes.Commands in '..\..\src\Pipes.Commands.pas',
  Pipes.ThreadingTests in 'Pipes.ThreadingTests.pas',
  Pipes.FramingTests in 'Pipes.FramingTests.pas',
  Pipes.CompressionTests in 'Pipes.CompressionTests.pas',
  Pipes.TopicsTests in 'Pipes.TopicsTests.pas',
  Pipes.CommandsTests in 'Pipes.CommandsTests.pas',
